-- ============================================================
-- SCQ Verdelandia -- Setup completo do banco PostgreSQL v2
-- Execute no Supabase Dashboard -> SQL Editor -> New query
-- Inclui: Lote, Analise atualizada, FichaEmbalagem, Coleta
-- ============================================================

-- ------------------------------------------------------------
-- 1. DROP (ordem inversa das FK)
-- ------------------------------------------------------------
...
ALTER TABLE "Analise"
    ...
    FOREIGN KEY ("produtorId") REFERENCES "Produtor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "ColetaAmostra"
    ...
    FOREIGN KEY ("produtorId") REFERENCES "Produtor"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- ------------------------------------------------------------
-- 5. SEED — Usuarios (senha "123456", bcrypt rounds=10)
-- ------------------------------------------------------------
...
-- 8. SEED — Analises
-- ------------------------------------------------------------
INSERT INTO "Analise" ("produtorId", "loteId", "ticket", "percentualPalito", "teorPo", "umidade", "desconto")
...
-- ------------------------------------------------------------
-- 9. SEED — Ficha de embalagem (4 parametros fixos)
-- ------------------------------------------------------------
INSERT INTO "FichaEmbalagem" ("loteId", "fornecedor", "parametros", "statusGlobal")
SELECT l.id,
    'Ervateira Central Ltda',
    '[{"resultado":"0.85","unidade":"g/cm3","padrao":"0.80-0.90","unidadePadrao":"g/cm3","conforme":true},{"resultado":"15x10","unidade":"cm","padrao":"15x10","unidadePadrao":"cm","conforme":true},{"resultado":"OK","unidade":"","padrao":"Sem defeitos","unidadePadrao":"","conforme":true},{"resultado":"7898901234560","unidade":"","padrao":"7898901234560","unidadePadrao":"","conforme":true}]',
    'CONFORME'
